"""ARCHIVED 2026-04-29: historical score-path diagnostic from Phase 2.
...
This script is preserved as provenance for the consolidation decision in
`backtest/ENGINE_CONSOLIDATION_DESIGN.md`. It is not part of the active
research path.
"""
